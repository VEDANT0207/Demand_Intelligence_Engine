...
class OperationalIntelligenceEngine:
    ...
    def _calculate_demand_metrics(
            ...
            sales_deviation = (
                (predicted_sales - historical_avg_sales)
                / historical_avg_sales
                * 100
                if historical_avg_sales != 0 else None
            )
            ...
            customer_deviation = (
                ...
                * 100
                if historical_avg_customers != 0 else None
            )
    ...
    def _calculate_trend_metrics(
        ...
        customer_trend = (
            ((recent_customers_avg - previous_customers_avg) / previous_customers_avg) * 100
    ...
    def generate_operational_intelligence(
        ...
        demand_metrics = self._calculate_demand_metrics(
            prediction_df,
            store_history_df
        )
        ...
        promotion_metrics = self._calculate_promotion_metrics(
            feature_df
        )
    ...
    def generate_batch_operational_intelligence(
        ...
        open_store_df = prediction_df[
            prediction_df["Open"] == 1
        ]
    ...
    def _calculate_forecast_summary(
        ...
        summary = {
            ...
            "lowest_sales":
                round(
                    forecast_df["Predicted_Sales"].min(),
                    2
                ),

            "sales_volatility_percent":
                round(
    ...
    def _calculate_peak_forecast_days(
        self,
        forecast_df: pd.DataFrame
    ):
    ...
    def generate_forecast_operational_intelligence(
        self,
        forecast_df: pd.DataFrame
    ):
