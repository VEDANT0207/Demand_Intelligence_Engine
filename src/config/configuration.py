...
class ConfigurationManager:
    ...
    def get_visualization_config(self):
        ...
        return {
            ...
            "summary_plot_path": visualization_dir / "summary_plot.png",
            "dependence_plot_path": visualization_dir / "dependence_plot.png",
            "force_plot_path": visualization_dir / "force_plot.html",
        }
    ...
    def get_forecast_visualization_config(self):
        ...
        forecast_visualization_dir = (
            self.project_root / "artifacts" / "forecast_visualizations"
        )

        forecast_visualization_dir.mkdir(parents=True, exist_ok=True)

        return {
            "forecast_visualization_dir": forecast_visualization_dir,
            "sales_forecast_plot_path": forecast_visualization_dir
            / "sales_forecast.png",
            "customer_forecast_plot_path": forecast_visualization_dir
            / "customer_forecast.png",
            "weekly_sales_plot_path": forecast_visualization_dir
